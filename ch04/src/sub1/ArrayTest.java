...
public class ArrayTest {
	public static void main(String[] args) {
		...
		System.out.println(arr2[1]);	//B 출력
		System.out.println(arr3[1]);	//대전 출력
		System.out.println(arr3[3]);	//부산 출력
		System.out.println(arr3[4]);	//광주 출력
		...
		//1차원 배열
		int[] scores = {80,60,78,62,92}; //배열이름은 복수형태를 붙여서 네이밍
		int total = 0;
